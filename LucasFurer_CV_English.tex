...
\begin{tikzpicture}[remember picture, overlay, shift={(current page.north west)}]
	...
	{
A detail-oriented and enthusiastic MSc Computer Science graduate with a passion for high-performance computing and physics-based simulations. I am an eager learner who enjoys collaborating with others and exploring new technologies. Experienced with C++, Python, Java and Docker.
	};
		...
		at ($(eduStart) + (\horGapSmall,0)$)
	{
		...
		$\bullet$ \textbf{Notable courses:} Security \& Cryptography, Reasoning About Software, Systems Security\\
	};
		...
		at ($(eduEntryA.south west) + (0,-\vertTextGap)$)
	{
		...
		$\bullet$ \textbf{Notable courses:} Data Mining, Big Data Processing, Collaborative AI\\
	};
	\node[anchor=north east, align=left] 
...
%	};
		...
		at ($(expEntryB.south west) + (0,-\vertSubGap)$)
	{
		...
		$\bullet$ Designed the databaseschema and build the application using Spring Boot, JavaFX en GitLab CI/CD\\
		$\bullet$ Fulfilled the rol of Scrum Master in an Agile team
	};
	\node[anchor=north east, align=left] 
		at ($(expEntryC.north west) + (\horGapLarge,0)$)
	{
