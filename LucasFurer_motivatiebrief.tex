...
\vspace{1em}
Graag solliciteer ik naar de functie van R\&D Engineer Battlelabs \& Wargaming. Recentelijk heb ik mijn master Computer Science aan de TU Delft afgerond, met een specialisatie in computergraphics en ik breng deze kennis graag in bij de ontwikkeling van realistische simulaties en wargamingomgevingen.\\
\vspace{1em}
Wat mij aanspreekt in deze functie is het creëren en simuleren van complexe scenario's. In mijn jongere jaren uitte deze interesse zich in de vorm van strategiegames zoals Civilization V en Stellaris. Sinds het begin van mijn universitaire opleiding is deze interesse meer verschoven naar het programmeren van physics-based simulaties. Daarnaast vind ik het maatschappelijke belang van dit werk erg belangrijk. Het spreekt mij aan dat ik met mijn technische kennis kan bijdragen aan toepassingen die niet alleen technisch uitdagend zijn, maar ook een duidelijke waarde hebben voor de veiligheid en weerbaarheid van de samenleving.\\
\vspace{1em}
...
\vspace{1em}
Ik zie mezelf als een nieuwsgierige en analytische software engineer die graag werkt aan technisch complexe vraagstukken. Ik krijg energie van het begrijpen van een probleem en het vervolgens ontwikkelen van een degelijke oplossing die betrouwbaar en bruikbaar is in de praktijk. De mogelijkheid om binnen een multidisciplinair team bij te dragen aan het opzetten en ontwikkelen van realistische en flexibele simulatieomgevingen spreekt mij daarom erg aan.\\
\vspace{1em}
Graag zet ik mijn technische kennis, leervermogen en enthousiasme in om bij te dragen aan innovatieve en realistische simulaties en wargamingomgevingen. Ik licht mijn motivatie en achtergrond graag verder toe in een persoonlijk gesprek.\\
\vspace{1em}
