...
Dear Nixxes team,\\
\vspace{1em}
I am writing to apply for the Graphics Programmer position at Nixxes Software. I recently graduated from TU Delft with a Master's degree in Computer Science, specializing in physics-based simulations and computer graphics. I would be excited to bring that experience to your team.\\
\vspace{1em}
What draws me to Nixxes is the chance to work on state of the art graphics and lighting techniques within a team that is trusted to bring some of PlayStation's biggest titles to new platforms. I am an agile and self-sufficient person who is comfortable taking ownership of a problem and driving it to completion without needing a lot of structure around me.\\
\vspace{1em}
My interest in graphics and simulation is what turned programming from a routine skill into a genuine passion. Early on, coding was more about solving the problem at hand. Once I started creating graphics and simulation software, I began to truly enjoy what I had made. For my Master's thesis, I implemented a fast multipole N-body solver in C++ and integrated it into t-SNE with an OpenGL visualization layer to inspect the results directly. My Bachelor's thesis explored how ray reflection distributions evolve under microstructure smoothing, again implemented in C++. Outside of my coursework, I built a Blender addon that generates terrain using simulated hydraulic erosion. I also led a small team building procedural terrain generation with Perlin noise and Marching Cubes in Unity. This combination of low-level C++ work and hands-on graphics implementation is exactly the kind of work I want to keep doing, and I believe it makes me a strong fit for a graphics programming role like this one.\\
\vspace{1em}
Beyond the technical side, I bring strong team and communication experience as well. During my internship at Feedback Analytics, I led a five-person team and worked directly with the client to gather requirements, which taught me how to communicate clearly and keep a project moving under deadlines without heavy oversight.\\
\vspace{1em}
I would welcome the opportunity to contribute to Nixxes' work, whether on rendering, lighting, or platform-level optimization. Thank you for considering my application. I would be glad to discuss how my background could fit your team.\\
\vspace{1em}
Sincerely,\\
Lucas Furer
	};
