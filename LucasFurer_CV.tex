...
\begin{tikzpicture}[remember picture, overlay, shift={(current page.north west)}]
	...
	% --- summary ------------------------------------
	\node[anchor=north west, text width=13.7cm,align=left, text=white, font=\large] at (6.8, -4.6)
	{
...
Ik ben een nauwkeurige en gemotiveerde MSc in Computer Science met een sterke basis in C++ en Python. Ik werk graag samen in een hecht team, denk actief mee over de beste technische oplossingen en maak nieuwe technologieën en tools snel eigen. Ik heb ervaring met C++, Python, Java, GLSL en Docker.
	};
