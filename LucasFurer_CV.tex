...
\begin{tikzpicture}[remember picture, overlay, shift={(current page.north west)}]
	...
	% --- summary ------------------------------------
	\node[anchor=north west, text width=13.2cm,align=left, text=white, font=\large] at (7.0, -4.35)
	{
A detail-oriented and enthusiastic MSc Computer Science graduate with a passion for high-performance computing, physics-based simulations and a strong interest in the financial industry. I am an eager learner who enjoys collaborating with others and exploring new technologies. Experienced with\\ C++, Java, GLSL and Python.
	};
