...
Ik ben een nauwkeurige en gemotiveerde MSc in Computer Science met een passie voor physics-based simulaties en computer graphics. Ik werk graag samen in een hecht team, denk actief mee over de beste technische oplossingen en maak nieuwe technologieën en tools snel eigen. Ik heb ervaring met C++, Python, Java, GLSL en Docker.
	};
