...
Ik ben een nauwkeurige en gemotiveerde MSc in Computer Science met een passie voor physics-based simulaties en high-performance computing. Ik werk graag samen in een hecht team, denk actief mee over de beste technische oplossingen en maak nieuwe technologieën en tools snel eigen. Ik heb ervaring met C++, Python, Unity en GLSL.
	};
		...
		at ($(eduEntryA.south west) + (0,-\vertTextGap)$)
	{
		...
		$\bullet$ \textbf{Relevante vakken:} Linear Algebra, Big Data Processing, Computer Graphics\\
	};
	\node[anchor=north east, align=left] 
